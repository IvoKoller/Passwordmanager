            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        'To the right you see your current security score. It tells you how safe your current passwords are. In order to improve your security score, check the list of issues below.',
                        React.createElement(
                            'h4',
                            null,
    ...
    createClass(Setup, [{
        ...
        value: function submit() {
            ...
            hashPassword(this.state.firstPassword, function (err, masterPassword) {
                ...
                appDir.write('app/config.json', { masterPassword: masterPassword });
                //set in redux store
...
var Layout = (_dec = reactRedux.connect(function (store) {
    ...
    createClass(Layout, [{
        ...
        value: function componentWillMount() {
            var app = electron.remote.app;
            var appDir = jetpack.cwd(app.getAppPath());
            var config = appDir.read('app/config.json', 'json');
            if (config !== undefined) {
                    ...
                    React.createElement(
                        ...
                        this.props.searchState ? React.createElement(
                            ...
                            title: React.createElement(
                                'span',
                                null,
                                this.props.showSingleEntry ? this.props.activeEntry.title : this.props.activePage.title
                            )
                        }),
                        React.createElement(
                            'div',
                            { style: { flex: 1, padding: 20, overflowY: 'scroll', background: this.props.theme.palette.secondaryCanvasColor } },
                            React.createElement(
                                Paper,
                                { style: { padding: 20 } },
                                this.page()
